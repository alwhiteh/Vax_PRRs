...
#Load the RDS files
m_lung_angel <- readRDS("mouse_as_human/m_lung_angelidis_h.RDS") #4872
m_lung_sam2 <- readRDS("mouse_as_human/m_lung_sam2_h.RDS") #4621
m_lung_sam3 <- readRDS("mouse_as_human/m_lung_sam3_h.RDS") #4621
m_lung_sam4 <- readRDS("mouse_as_human/m_lung_sam4_h.RDS") #4621
m_lung_kras <- readRDS("mouse_as_human/m_lung_kras_h.RDS") #E4344
m_lung_rare_f <- readRDS("mouse_as_human/m_lung_rare_f_h.RDS") #3747
m_lung_rare_m <- readRDS("mouse_as_human/m_lung_rare_m_h.RDS") #3747
m_lung_koenitzer1 <- readRDS("mouse_as_human/m_lung_koenitzer1_h.RDS")
m_lung_koenitzer2 <- readRDS("mouse_as_human/m_lung_koenitzer2_h.RDS")
m_lung_koenitzer3 <- readRDS("mouse_as_human/m_lung_koenitzer3_h.RDS")
...
write.csv(mlung.combined.markers,"mouse_as_human/mlung.combined.markers.csv")
...
saveRDS(mlung.combined, "mouse_as_human/m_lung_combined_h.RDS")
